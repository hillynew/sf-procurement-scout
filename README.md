...
| **FACTS** | 1 | **Contract register, not a bid feed.** Every executed state contract under s. 215.985(14) — 12,377 with a live end date, 10,192 expiring within a year. Two POSTs: run the search, download the CSV |
